...
{
    public static void playMusic(String filepath) throws IOException, LineUnavailableException, UnsupportedAudioFileException, SQLException, ClassNotFoundException {
